  ...
  def create
    ...
    respond_to do |format|
      if @blog_article.save
        format.html { redirect_to blog_article_url(@blog_article), notice: "Blog article was successfully created." }
  ...
  def update
    respond_to do |format|
      if @blog_article.update(blog_article_params)
        format.html { redirect_to blog_article_url(@blog_article), notice: "Blog article was successfully updated." }
