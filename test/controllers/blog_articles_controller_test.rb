...
class BlogArticlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blog_article" do
    assert_difference("BlogArticle.count") do
      post blog_articles_url, params: { blog_article: { description: @blog_article.description, title: @blog_article.title } }
    end
  ...
  test "should update blog_article" do
    patch blog_article_url(@blog_article), params: { blog_article: { description: @blog_article.description, title: @blog_article.title } }
